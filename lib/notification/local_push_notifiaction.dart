...
import 'package:flutter_notification/notification/flutter_local_notification.dart';
import 'package:flutter_notification/notification/model/recived_notification.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';

final loaclPushNotificationProvider = Provider<LocalPushNotification>((ref) {
  final notificationsPlugin = ref.watch(flutterLocalNotificationProvider);
  return LocalPushNotification(notificationsPlugin);
});

class LocalPushNotification {
  final FlutterLocalNotificationsPlugin notificationsPlugin;
  LocalPushNotification(this.notificationsPlugin) {
    _init();
  }
  ...
  void showNotification(RecivedNotification notification) async {
